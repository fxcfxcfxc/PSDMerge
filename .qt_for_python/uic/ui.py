...
class Ui_TextureMange(object):
    def setupUi(self, TextureMange):
        ...
        font2 = QFont()
        font2.setFamily(u"BIZ UDPGothic")
        ...
        font3.setWeight(50)
        self.r_pushButton.setFont(font3)
    ...
    def retranslateUi(self, TextureMange):
        TextureMange.setWindowTitle(QCoreApplication.translate("TextureMange", u"PSDMerge_v1.0", None))
        ...
        self.tex_json.setText(QCoreApplication.translate("TextureMange", u"\u4fdd\u5b58\u540d\u79f0\u9884\u8bbe", None))
        ...
        self.label_image.setText(QCoreApplication.translate("TextureMange", u"\u56fe\u7247", None))
        self.pngname_lineEdit.setText(QCoreApplication.translate("TextureMange", u"\u540d\u5b57", None))
        ...
        self.tabWidget.setTabText(self.tabWidget.indexOf(self.tab), QCoreApplication.translate("TextureMange", u"PsdTexture", None))
